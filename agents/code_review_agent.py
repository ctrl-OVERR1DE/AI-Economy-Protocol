...
PROVIDER_WALLET = load_agent_wallet("CodeReviewAgent")
...
async def startup(ctx: Context):
    ...
    ctx.logger.info(f"💰 Base Pricing: {code_reviewer.BASE_PRICE} Tokens (~${code_reviewer.BASE_PRICE})")
        ...
        response = requests.post(
            ...
            json={
                ...
                "services": [{
                    ...
                    "base_price": code_reviewer.BASE_PRICE,
                    "description": "AI-powered code review with Gemini",
                    "features": code_reviewer.get_service_info()['features'][:5],
    ...
    for item in msg.content:
        ...
        if isinstance(item, StartSessionContent):
            ...
            welcome_msg = create_text_chat(
                ...
                f"Base price: {service_info['base_price']} Tokens (~${service_info['base_price']}). "
...
"""
                ...
                try:
                    ...
                    if escrow_pda_str:
                        ...
                        payment_success, payment_data, payment_error = await gateway.claim_payment(
                            ...
                            service_type="code_review",
                            amount=code_reviewer.BASE_PRICE,
                            max_retries=3,
                            retry_delay=5
                        )
                ...
                response_message = create_text_chat(
                    ...
                    f"Service fee: {code_reviewer.BASE_PRICE} Tokens (~${code_reviewer.BASE_PRICE}). "
